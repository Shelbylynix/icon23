	...
	Themes = {
		Cyberpunk = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(180, 50, 255)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 0, 0)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 180, 255))
			}),
			["Color Hub 2"] = Color3.fromRGB(15, 10, 25),
			["Color Stroke"] = Color3.fromRGB(100, 60, 200),
			["Color Theme"] = Color3.fromRGB(180, 50, 255),
			["Color Text"] = Color3.fromRGB(230, 220, 245),
			["Color Dark Text"] = Color3.fromRGB(150, 140, 180)
		}
	},
	Save = {
		UISize = {550, 380},
...
function NovaUI:MakeWindow(Configs)
	...
	function Window:MakeTab(paste, Configs)
		...
		function Tab:AddToggle(Configs)
			...
			Make("Gradient", ToggleHolder, {Rotation = 45})
		...
		function Tab:AddDropdown(Configs)
			...
			Make("Gradient", SelectedFrame, {Rotation = 45})
		...
		function Tab:AddSlider(Configs)
			...
			Make("Gradient", SliderBar, {Rotation = 45})
		...
		function Tab:AddDiscordInvite(Configs)
			...
			Make("Gradient", JoinButton, {Rotation = 45})
			Make("Stroke", JoinButton)
